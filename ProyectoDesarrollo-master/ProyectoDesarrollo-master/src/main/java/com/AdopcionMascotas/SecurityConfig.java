  ...
  @Override
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .hasRole("ADMIN")
                .antMatchers("/leercomentarios","/leerusuarioU",  "/index2", "/leergatosU", "/login", "/donaciones", "/alimentos.html", "/acercaDe.html", "/gatos.html", "/perros.html", "/index.html", "/donacionesN", "/leergatos")
